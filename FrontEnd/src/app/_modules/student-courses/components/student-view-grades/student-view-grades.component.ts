...
const DATA: StudentTable[] = [
  ...
  },
  {
    ...
    Year: 1,
    SeminarAttendances:  [false, false, false, true, true, true, true, true, true, true, true, true, true, true],
    LabAttendances: [true, false, false, true, true, true, true, true, true, true, true, true, true, true],
...
@Component({
  ...
  templateUrl: './student-view-grades.component.html',
  styleUrls: ['./student-view-grades.component.css']
})
export class StudentsViewGradesComponent implements OnInit {
  data = DATA;
